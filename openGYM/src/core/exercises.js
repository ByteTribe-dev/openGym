...
// Keep media identifiers platform-independent. Native asset resolution lives in the
// media service so the exercise catalogue and business logic never import Expo APIs.
export const imgSrc = ex => ex?.img || null
export const gifSrc = ex => ex?.gif || null
